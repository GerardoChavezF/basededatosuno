-- Crear una secuencia para generar valores de idcliente autom�ticamente
...
--consulta #8
SELECT YEAR(fecha_crea) a�o, MONTH(fecha_crea) mes, COUNT(*) total_casos
FROM Casos
...
VALUES
    (2, 'Mar�a', 'Gomez', 55000, 'Ventas'),
    (3, 'Luis', 'Rodriguez', 70000, 'Tecnolog�a'),
